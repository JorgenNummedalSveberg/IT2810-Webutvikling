...
function GridView() {
    ...
    {title: "Lion King",duration: "PT103M", year: "1994", rating: "8.1", poster: "test_posters/lion_king.jpg"},
  ...
  const openPopup = (id:any) => {
    ...
    return (
      <div className="GridView">
        {movies.map((movie) => (
          <Movieposter tittel={movie.title} year={movie.year} poster={movie.poster}/>
        ))}
      </div>
    );
  }
