...
function MovieSectionContainer(props: { refresh: (number: number) => void, error: boolean }) {
    ...
    return (
        <MovieSection
            ...
            classes={{
                root: classes().root,
                moviePage: classes().moviePage,
                popup: classes().popup,
                main: classes().main,
                movieGrid: classes().movieGrid,
                errorPage: classes().errorPage,
                details: cardClasses().details,
                gridItem: cardClasses().gridItem,
                title: cardClasses().title,
                description: cardClasses().description,
                bottomInfo: cardClasses().bottomInfo}}
