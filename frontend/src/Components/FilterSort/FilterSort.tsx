    ...
    return (
        <div className={props.classes.thin}>
            ...
            <Drawer anchor={'top'} open={props.openSorting} onClose={() => props.setSortingOpen(false)}>
                <Button data-testid='mobileSortClose' startIcon={<ArrowBackIcon/>}
                        onClick={() => props.setSortingOpen(false)}>Close</Button>
            ...
            <Drawer anchor={'left'} open={props.openFilter} onClose={() => props.setFilterOpen(false)}>
                <Button data-testid='mobileFilterClose' startIcon={<ArrowBackIcon/>}
                        onClick={() => props.setFilterOpen(false)}>Close</Button>
