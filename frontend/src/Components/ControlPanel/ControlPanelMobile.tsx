...
function ControlPanelMobile(props: { refresh: () => void, show:boolean }) {
    ...
    return (
        <div className="MobilePanelWrapper">
            <div className="MobilePanel" style={{visibility:props.show ? "visible":"hidden"}}>
